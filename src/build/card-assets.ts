...
export const CARD_ASSETS_VERSION = '3';
...
const CARD_CSS: Record<(typeof CARD_NAMES)[number], string> = {
  ...
  signup:
    '.kg-signup-card{display:flex;flex-direction:column;align-items:center;gap:1rem;padding:3rem 2rem;border-radius:8px;background:#f5f5f5;text-align:center}.kg-signup-card-heading{margin:0}.kg-signup-card-subheading{margin:0;max-width:42rem}.kg-signup-card-form{display:flex;gap:.5rem;max-width:32rem;width:100%}.kg-signup-card-input{flex:1;min-width:0;padding:.75em 1em}.kg-signup-card-button{padding:.75em 1em;border:0;border-radius:4px;background:var(--ghost-accent-color,#15171a);color:#fff;font-weight:700}',
  toggle:
