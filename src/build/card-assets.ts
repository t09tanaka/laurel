...
const CARD_CSS: Record<(typeof CARD_NAMES)[number], string> = {
  ...
  bookmark:
    ...
    '.kg-bookmark-card{width:100%}.kg-bookmark-container{display:flex;min-height:148px;color:inherit;text-decoration:none;border:1px solid rgba(0,0,0,.12);border-radius:5px;overflow:hidden}.kg-bookmark-content{display:flex;flex:1;flex-direction:column;justify-content:flex-start;padding:20px;min-width:0}.kg-bookmark-title{font-weight:700}.kg-bookmark-description{margin-top:.5rem;color:rgba(0,0,0,.68);display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.kg-bookmark-metadata{display:flex;align-items:center;gap:.5rem;margin-top:auto;font-size:.85em;color:rgba(0,0,0,.6)}.kg-bookmark-metadata .kg-bookmark-icon{flex:0 0 20px;width:20px;height:20px;max-width:20px;object-fit:contain}.kg-bookmark-thumbnail{position:relative;flex-grow:1;min-width:33%;max-height:100%}.kg-bookmark-thumbnail img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover}',
  button:
