...
async function writeSettings(outputDir: string, site: SiteData): Promise<void> {
  const settings = {
    ...
    bluesky: site.bluesky ?? null,
    mastodon: site.mastodon ?? null,
    threads: site.threads ?? null,
    tiktok: site.tiktok ?? null,
    youtube: site.youtube ?? null,
    instagram: site.instagram ?? null,
    github: site.github ?? null,
...
async function writeRedirects(
  ...
  const lines: string[] = [
    '# Ghost Content API trailing-slash routing (auto-generated by laurel)',
...
function serializePost(
  ...
  return {
    ...
    email_only: post.email_only ?? false,
    email_subject: post.email_subject ?? null,
    email: null,
    send_email_when_published: post.send_email_when_published ?? false,
