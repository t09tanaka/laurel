...
`,
  ...
  test('emits Ghost-compatible card assets when the theme package opts in', async () => {
    ...
    expect(indexHtml).toContain('/blog/assets/ghost-card-assets.css?v=3');
    expect(indexHtml).not.toContain('/blog/assets/ghost-card-assets.js?v=3');
  });
...
`,
    ...
    expect(indexHtml).not.toContain('/blog/assets/ghost-card-assets.js?v=3');
    expect(postHtml).toContain('/blog/assets/ghost-card-assets.js?v=3');
