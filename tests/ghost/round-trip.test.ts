...
const EXPECTED_LOSS = {
  ...
  image: {
    reason:
      'Ordinary static Ghost image cards intentionally import as editor-friendly Markdown images, so non-Markdown image metadata such as width/height/srcset is regenerated by Nectar instead of round-tripping byte-for-byte.',
